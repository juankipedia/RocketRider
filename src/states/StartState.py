...
class StartState(BaseState):
    def enter(self, *args: Tuple[Any], **kwargs: Dict[str, Any]) -> None:
        self.selected = 0
        pygame.mixer_music.load(settings.BASE_DIR / "sounds" / "music_main_menu.mp3")
